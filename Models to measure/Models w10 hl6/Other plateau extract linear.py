...
derivatives_tensor = derivatives_tensor[10000:20000]
number_of_steps = number_of_steps[10000:20000]
...
fig = plt.figure()
ax = fig.subplots()
fig.suptitle(f"Second and more plateaus derivatives bs{batch_size} w{width} hl{hidlay} v{u+1} ft{filter_times} win{window}")
...
fig.savefig(f"Other_plateau_derivatives_bs{batch_size}_w{width}_hl{hidlay}_v{u+1}_ds{dataset_size}_e{epochs}_tt{training_times}.pdf")
