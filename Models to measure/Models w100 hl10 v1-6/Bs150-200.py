# -*- coding: utf-8 -*-
"""
Created on Mon May 16 16:41:04 2022
...
for u in range(version):
    ...
    for i in range(3):
        ...
        plt.plot(number_of_steps[0:30000], loss_values_train[0:30000],'-')
        plt.yscale('log')
        ...
        batch_size += 25
    plt.legend(['Bs 150','Bs 175','Bs 200'])
    plt.show()
    fig.savefig(f"Batch size 150 - 200 values of w{width} hl{hidlay} v{u+1}.pdf", bbox_inches = 'tight')
