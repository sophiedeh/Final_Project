...
for u in range(version):
    ...
    for i in range(training_times):
            ...
            # Load loss values
            loss_values_train = torch.load(f"Loss_values_train_2nd_bs{batch_size}_w{width}_hl{hidlay}_v{u+1}_ds{dataset_size}_e{epochs}_tt12.pt")
            ...
            loss_values_train_filtered = loss_values_train_filtered[100:1000]
